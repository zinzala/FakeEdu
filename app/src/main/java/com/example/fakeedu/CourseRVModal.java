...
// when we pass data one activity to another we use parcelable
public class CourseRVModal implements Parcelable {
    ...
    // i am creation empty constructor because when we perform crud operation with firebase database empty constructor is required

    public CourseRVModal(){

    }

    // after creating constructor i am creating getter() and setter methode()
